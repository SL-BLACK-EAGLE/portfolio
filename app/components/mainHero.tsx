  ...
  return (
    <div className=" min-h-screen pt-[120px] pb-[90px] lg:py-[180px]">
      <div className="h_container font_apoc flex flex-col items-center  px-2 pb-[20vw]  lg:pb-[4vw]">
        ...
        <h1 className="h_title relative w-full text-center text-[15vw] font-light uppercase leading-[90%] lg:text-[8.7vw] ">
          <span className="-mb-1.5 -mt-6 inline-block overflow-hidden align-bottom">
            <span className="font_aeonik inline-block  translate-y-full pb-1.5  pt-6    font-bold leading-[81%] text-orange will-change-transform ">
              By Loving
            </span>
          </span>
          <span className="-mb-1.5 -mt-6 inline-block overflow-hidden align-bottom">
        ...
        <div
          ...
          style={{ opacity: 0 }}
          className="scale-80 rotate-[4.24deg] lg:-translate-y-2 lg:-translate-x-8 lg:scale-105 "
        >
          <Player
            src={likeCrazyLottie}
            ref={playerRef}
